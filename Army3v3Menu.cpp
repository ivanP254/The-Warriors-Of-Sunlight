#include "Army3v3Menu.h"

Army3v3Menu::Army3v3Menu(Adapter* ad)
{
	a = ad;
...
void Army3v3Menu::printMenu()
{
	...
	for (int i = 1; i <= 5; i++) {
		...
		GAP(4);
		printArrow(currentArmy == 1, i, COLOR_RED);
		GAP(3);
		print(char(64), COLOR_RED);


		GAP(2);
		printPlus(army.size() > 12, i, COLOR_BLACK);
		GAP(2);

		if (army.size() > 12) {
			for (int unit = army.size() - 12; unit < army.size(); unit++) {
				GAP(3);
	...
	for (int i = 1; i <= 5; i++) {
		...
		GAP(4);
		printArrow(currentArmy == 2, i, COLOR_RED);
		GAP(3);
		print(char(64), COLOR_RED);
	...
	for (int i = 1; i <= 5; i++) {
		...
		GAP(4);
		printArrow(currentArmy == 3, i, COLOR_RED);
		GAP(3);
		print(char(64), COLOR_RED);
...
int Army3v3Menu::getMoney()
{
	return a->getCurrentMoney();
}

int Army3v3Menu::getUnitCost(int unit)
{
	return(a->getUnitCost(unit));
}

int Army3v3Menu::getUnitHp(int unit)
{
	return(a->getUnitHp(unit));
}

int Army3v3Menu::getUnitAtk(int unit)
{
	return(a->getUnitAtk(unit));
}

int Army3v3Menu::getUnitDef(int unit)
{
	return(a->getUnitDef(unit));
}

std::vector<int> Army3v3Menu::getArmy(int army)
{
	return a->getCurrentArmy(army);
}

void Army3v3Menu::addUnit()
{
	a->addUnit(currentUnit, currentArmy);
}
